...
# DYNAMIC VENV activation from PYENV

venv() {
 local project_name=$1
 local venv_path="$HOME/.pyenv/versions/${project_name}/bin/activate"
 if [ -f "$venv_path" ]; then
  source "$venv_path"
...
# Web Project Shell Scripts
export PATH=$PATH:/mnt/c/Users/andre/Repositories/Portfolio/Sample8_ML.Flask.Web.Application/aws_eb_deploy/shell_scripts
